...
public class FER_NumeroFilas extends JLabel implements Serializable {
    ...
    public FER_NumeroFilas()
    {
        this.setText("Número de filas:_ ? ");
   ...
   public void cambioElEstado(PropertyChangeEvent evt) 
    {
       ...
       synchronized (this)  
        { if ( CONSTANTES.CONSULTA_NUMERO_FILAS.equals(evt.getPropertyName()) ) // Solo atiendo a la que me interesa        
               {
                    int columnas= (int) evt.getNewValue();
                    this.setText("Número de filas:;  "+columnas);
